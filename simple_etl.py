#!/usr/bin/env python3
"""
Simplified ETL script that runs without Prefect orchestration.
This can be used in environments where Prefect server is not available.
"""
...
def transform_cdc_data(raw_data):
    """Transform and normalize raw CDC data into clean format."""
